...
$dest = "c:\Users\aniya\Downloads\flood\flood\images\water-chestnut.jpg"
# Get the absolute latest file (likely the Water Chestnut image just uploaded)
...
if($img){
    ...
    Write-Host "Updated water-chestnut.jpg with $($img.Name)"
} else {
